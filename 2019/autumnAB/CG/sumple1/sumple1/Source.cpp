...
void display(void) {
	...
	glColor3d(0.1, 0.3, 0.5);   // �F�w��(R,G,B)��0�`1�܂�
	glBegin(GL_LINE_LOOP);      // �`�悷����̂��w��
	for (int i = 0; i < 720; i = i + 144) {
		double x = sin(i * 3.14159 / 180.0);
		double y = cos(i * 3.14159 / 180.0);
